...
public class VistaMedicos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField3.setToolTipText("Ingrese la especialidad que desea buscar");
    ...
    private void boton_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_buscarActionPerformed
        ...
        String buscarEspecialidad = jTextField3.getText().trim();
        ...
        String sql = "select persona.dni_persona,persona.nombre_persona,persona.apellido_persona,medico.especialidad_medico,medico.numero_licencia,medico.sueldo_medico FROM medico INNER JOIN persona ON medico.id_persona=persona.id_persona WHERE persona.nombre_persona LIKE ? AND persona.apellido_persona LIKE ? AND medico.especialidad_medico LIKE ?";
        ...
        try{
            ...
            ps.setString(3, "%" + buscarEspecialidad + "%");
            rs = ps.executeQuery();
            while(rs.next()){
        ...
        tabla.addColumn("Numero Licencia");
        ...
        for(int f=0; f<lista.size();f++){
            ...
            fila[3] = lista.get(f).getEspecialidad();
            fila[4] = lista.get(f).getNumerolicencia();
            fila[5] = lista.get(f).getSueldo();
            tabla.addRow(fila);
        }
    ...
    // End of variables declaration//GEN-END:variables
        ...
        for(int f=0; f<datos.size();f++){
            ...
            fila[3] = datos.get(f).getEspecialidad();
            fila[4] = datos.get(f).getNumerolicencia();
            fila[5] = datos.get(f).getSueldo();
            tabla.addRow(fila);
        }
        tblDatos.setModel(tabla);
    }
