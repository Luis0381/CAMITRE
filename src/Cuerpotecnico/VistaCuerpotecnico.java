 ...
 * @author 12mat
 */
public class VistaCuerpotecnico extends javax.swing.JFrame {
    ...
    private void boton_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_buscarActionPerformed
        ...
        String sql = "select persona.dni_persona,persona.nombre_persona,persona.apellido_persona, cuerpo_tecnico.sueldo_cuerpo, cuerpo_tecnico.cargo_cuerpo, cuerpo_tecnico.licencia_entrenador FROM cuerpo_tecnico INNER JOIN persona ON cuerpo_tecnico.id_persona=persona.id_persona WHERE persona.nombre_persona LIKE ? AND persona.apellido_persona LIKE ? AND cuerpo_tecnico.cargo_cuerpo LIKE ?";
        ...
        for(int f=0; f<lista.size();f++){
            ...
            fila[3] = valueOf(lista.get(f).getSueldo());
            fila[4] = lista.get(f).getCargo();
            fila[5] = lista.get(f).getLicencia();
            tabla.addRow(fila);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaCuerpotecnico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    // End of variables declaration//GEN-END:variables
        ...
        ArrayList<ModeloCuerpotecnico> datos;
        String[] fila = new String[45];
        tabla.addColumn("Dni");
        tabla.addColumn("Nombre");
        tabla.addColumn("Apellido");
        ...
        for(int f=0; f<datos.size();f++){
            ...
            fila[3] = valueOf(datos.get(f).getSueldo());
            fila[4] = datos.get(f).getCargo();
            fila[5] = datos.get(f).getLicencia();
            tabla.addRow(fila);
        }
        tblDatos.setModel(tabla);
    }
